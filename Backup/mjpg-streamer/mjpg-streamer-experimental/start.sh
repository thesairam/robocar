...
./mjpg_streamer -i "./input_uvc.so -d /dev/video2" -o "./output_http.so -p 8082 -w ./www" &
./mjpg_streamer -i "./input_uvc.so -d /dev/video3" -o "./output_http.so -p 8083 -w ./www" &
./mjpg_streamer -i "./input_uvc.so -d /dev/video4" -o "./output_http.so -p 8084 -w ./www" &
